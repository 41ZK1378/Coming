...
for z in range(200):
	...
	ua = f"FBDM/"+"{density=1.5,width=540,height=960};"+"FBLC/en_US;FBRV/183119516;FBCR/TM;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.mlite;FBDV/vivo 1807;FBSV/{versi_android};FBOP/1;FBCA/armeabi-v7a:armeabi;]"
