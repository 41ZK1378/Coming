...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-A146P Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/415.0.0.34.107.{str(random.randint(100000, 900000))};]"
