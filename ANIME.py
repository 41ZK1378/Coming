...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; TECNO LC8 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/402.0.0.11.10.{str(random.randint(100000, 900000))};]"
