...
for z in range(200):
	...
	device = random.choice(["SM-S911B Build/NHG47L","SM-S911B/DS Build/LMY47V","SM-S911U Build/N4F26T","SM-S911U1 Build/OPM5.171019.014","SM-S911W Build/OPR6.170623.023","SM-S911N Build/OPM5.171019.015","SM-S9110 Build/MMB29K","SM-S911B/DS Build/OPM6.171019.030.H1"])
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-S911U Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/de_DE;FBAV/358.0.0.8.62.{str(random.randint(100000, 900000))};]"
