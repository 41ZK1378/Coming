...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-A042M Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/418.0.0.33.69.{str(random.randint(100000, 900000))};]"
