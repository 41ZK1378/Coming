...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; GT-I9505 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/225.0.0.12.114.{str(random.randint(100000, 900000))};]"
