...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-G570M Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/de_DE;FBAV/344.0.0.10.83.{str(random.randint(100000, 900000))};]"
