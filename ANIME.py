...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; itel W7002 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/de_DE;FBAV/358.0.0.8.62.{str(random.randint(100000, 900000))};]"
