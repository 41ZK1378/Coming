...
for z in range(200):
	...
	ua = f"[FBAN/MessengerLite;FBAV/{versi_chrome};FBBV/193013937;FBDM/"+"{density=2.625,width=1080,height=1794};"+f"FBLC/en_US;FBRV/0;FBCR/Verizon;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.mlite;FBDV/Infinix X676C;FBSV/{versi_android};FBBK/1;FBOP/1;FBCA/arm64-v8a:;"
