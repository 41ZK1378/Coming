...
for z in range(200):
	...
	device = random.choice(["SM-N975F Build/NHG47L","SM-J320FN Build/LMY47V","SM-N750K Build/N4F26T","SM-A715W Build/OPM5.171019.014","SM-A908N Build/OPR6.170623.023","SM-N986B Build/OPM5.171019.015","SM-G988U Build/MMB29K","SM-A042F Build/OPM6.171019.030.H1"])
	...
	ua = f"[FBAN/MessengerLite;FBAV/{versi_chrome};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{versi_app};FBCR/Airtel;FBMF/Facebook/lge;FBBD/FEVER;FBDV/FEVER;FBSV/{versi_android};FBCA/armeabi-v7a:armeabi;FBDM/309.0.0.16.{str(random.randint(100000, 900000))};])"
